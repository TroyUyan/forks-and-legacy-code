...
/*
* @package WordPress
* @subpackage enfold-child
* Template Name: Investor Portal Locked Page
*/
				...
				<main class='content <?php avia_layout_class( 'content' ); ?> units' <?php avia_markup_helper(array('context' => 'content'));?>>
                    ...
                    if($blog_layout == 'blog-grid')
                    {
                        ...
                        echo "<div class='entry-content-wrapper'>".$blog->html()."</div>";
		                    ...
		                    # MANUAL FUNCTION
		                    # Logout and redirection link on bottom of pages that require you
		                    # to be logged in to see in the Investor Portal.
		                # END PHP ?>
		                    <p id="inv-logout-container">
		                    	<a href="<?php echo wp_logout_url("/the-investor-portal/"); ?>" title="Logout" id="inv-logout">Logout of Investor Portal</a>
		                    </p>
		                <?php # resume PHP    
                    }
                    else
