...
function port($portTitle, $desc, $imgurl, $porturl) { #end php ?>
		<div class="clear">
			...
			<h4><a href="<?php echo $porturl ?>"><?php echo $portTitle ?></a></h4>
			<a href="<?php echo $porturl ?>"><img src="<?php echo $imgurl ?>" class="floatl" width="150px" height="150px"></a>
			<p class="smallclear"><?php echo $desc ?><br><a href="<?php echo $porturl ?>">View Project &raquo;</a></p>
		</div>
	<?php #resume php
}
