...
<body>
	<div id="pagewrapper">
		...
		<?php 
			...
			if (!empty($_POST['name']) AND !empty($_POST['name']) AND !empty($_POST['name'])) {
				echo "<p>Thank you, <b>{$_POST['name']}</b> for the following comments:</p>";
				echo "<p><tt>{$_POST['comments']}</tt></p>";
				echo "<p>We will respond to you at <i>{$_POST['email']}</i> soon.";
			} else {
				echo "<p>Please go back and fill out the form again</p>";
				echo "<hr>";
			}

			// SHORTHAND AND REQUEST METHOD
