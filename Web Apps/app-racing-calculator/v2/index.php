  ...
  <body>
    ...
    <div class="contain-to-grid sticky">
      <nav class="top-bar" data-topbar data-options="sticky_on: small">
         <ul class="title-area">
          <li class="name">
            <h1><a href="http://troyuyan.com/"><span class="hide-small">Racing Calculator</span> By Troy Uyan</a></h1>
          </li>
...
// PHP end ?>
    ...
    <div id="footer" class="row clear">
      <div class="small-12 columns text-center">
        <p>Made with <span class="heart">&hearts;</span> by <a href="http://troyuyan.com">Troy Uyan</a></p>
      </div>
    </div>  
